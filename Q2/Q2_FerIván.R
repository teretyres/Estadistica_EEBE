...
sigmax<- 7.1
#apartado a
n_a<-121 #n_a> 30 -> distr. normal
mu_y<- n_a*mux; mu_y

#apartado b
n_b<- 25 #NaN porque n_b< 30 (TLC)

#apartado c
#Nan porque distr. no indicada

#apartado d
#lo mismo q apartado b

#apartado e
n_e<- 81
#P(x<=6687)
mu_e<-n_e*mux
sigma_e<- sqrt(n_e)*sigmax
pnorm(6687, mu_e, sigma_e)
